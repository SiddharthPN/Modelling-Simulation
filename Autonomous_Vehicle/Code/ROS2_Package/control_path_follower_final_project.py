...
class ControlPathFollowerNode(Node):
    def __init__(self):
        ...
        self.vehicle_speed = VehicleSpeed()
        ...
        self.sub_vehiclespeed = self.create_subscription(
            VehicleSpeed, 'vehiclespeed', self.vehiclespeed_callback, qos_profile)
    ...
    def vehiclespeed_callback(self,msg):
        self.vehicle_speed = msg
        self.get_logger().info("Vehicle Speed Subscribed: '%f'" % self.vehicle_speed.vehiclespeed)
    ...
    def pub_callback(self):
        ...
        speed_error = self.target_speed - \
            np.linalg.norm(self.vehicle_speed.vehiclespeed)
